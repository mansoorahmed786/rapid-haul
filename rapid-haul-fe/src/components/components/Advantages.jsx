    ...
    <section className="advantages">
      <div className="advantages-container">
        ...
        <p className="advantages-description">
          ...
          positive influence on your company's success.
        </p>
        <div className="advantages-grid">
          ...
          <div className="advantage-card">
            ...
            <p className="advantage-text">
              Our love for detailed bullet-point preparations as well as to
              open and clear project management and communication is what makes
              us faster than the competition. Recently we compared a technically
              similar oil & gas well we've built and installed pipes for and
              the...
            </p>
          </div>
          <div className="advantage-card">
            ...
            <p className="advantage-text">
              ...
              mindset of both our senior employees and all the way to our
              on site contractors and construction workers centers on attention.
              It is out attention to details that allows us to work on a
